...
1. Configure your [query]({{< relref "../panels/queries.md" >}}) by selecting `-- Enerview --` from the [data source selector]({{< relref "../panels/queries.md/#data-source-selector" >}}). This generates the Random Walk dashboard.
